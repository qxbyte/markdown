...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Down",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Down17DownLayoutManager")
...
SWIFT_CLASS("_TtC4Down22DownDebugLayoutManager")
...
SWIFT_CLASS("_TtC4Down12DownTextView")
@interface DownTextView : NSTextView
...
SWIFT_CLASS("_TtC4Down17DownDebugTextView")
